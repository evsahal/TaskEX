...
"background-repeat: no-repeat;")
        ...
        self.row_1 = QFrame(self.custom_tasks)
        ...
        self.row_2 = QFrame(self.custom_tasks)
...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
        ...
        self.row_3 = QFrame(self.custom_tasks)
...
"<html><head/><body><span style=\" font-size:12pt;font-weight:bold;\">TaskEnforcerX - </span> <span style=\" font-size:10pt;\">Smart Automation For Evony</span></body></html>", None))
        ...
        ___qtablewidgetitem19 = self.tableWidget.verticalHeaderItem(13)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem20 = self.tableWidget.verticalHeaderItem(14)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem21 = self.tableWidget.verticalHeaderItem(15)
