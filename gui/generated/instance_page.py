...
"border-radius: 5px;")
        ...
        self.rotate_preset_settings_ = QPushButton(self.widget_1082)
        self.rotate_preset_settings_.setObjectName(u"rotate_preset_settings_")
        self.rotate_preset_settings_.setMinimumSize(QSize(25, 25))
        self.rotate_preset_settings_.setMaximumSize(QSize(25, 25))
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/icons/cil-settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.rotate_preset_settings_.setIcon(icon4)
        self.rotate_preset_settings_.setCheckable(False)

        self.horizontalLayout_769.addWidget(self.rotate_preset_settings_)
...
"")
    ...
    def retranslateUi(self, InstancePage):
        ...
        self.rotate_preset_settings_.setToolTip(QCoreApplication.translate("InstancePage", u"Preset Settings", None))
#endif // QT_CONFIG(tooltip)
        self.rotate_preset_settings_.setText("")
#if QT_CONFIG(tooltip)
